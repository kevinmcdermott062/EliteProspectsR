...
#' @export
getCountry <- function(id=NULL, filters=NULL, sorts=NULL, fields=NULL, limit=0, offset=0){
  if(!is.numeric(id)){
    stop("Please enter a country id to get")
  }
  return(simple_get(path="countries/", id=id, filters=filters, sorts=sorts, fields=fields, limit=limit, offset=offset))
}
